...
public class AgendePersoane {
    public static void main(String[] args) {
        ...
        System.out.println(" ===== Printing agendaIonut content =====");
        System.out.println(agendaIonut.getAgendContent());
        //print agendaIonut content
        System.out.println(" ===== Updating something in agendaIonut =====");
        agendaIonut.updatePhoneNumberInAgenda("0333", "Daniel1");
        agendaIonut.updateNameOfPersonFromAgenda("03222", "Mugurel");
